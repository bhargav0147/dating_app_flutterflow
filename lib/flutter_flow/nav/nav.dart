...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Your_Interests_One',
          path: '/yourInterestsOne',
        ...
        FFRoute(
          ...
          path: '/reels',
          builder: (context, params) =>
              params.isEmpty ? const NavBarPage(initialPage: 'Reels') : const ReelsWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: '/matches',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Matches')
              : const MatchesWidget(),
        ),
        FFRoute(
          name: 'Setup_Profile',
        ...
        FFRoute(
          name: 'Multiple_Image_Set',
          path: '/multipleImageSet',
        ...
        FFRoute(
          name: 'Your_Interests_Two',
          path: '/yourInterestsTwo',
        ...
        FFRoute(
          name: 'New_Reel',
          path: '/newReel',
          builder: (context, params) => const NewReelWidget(),
        )

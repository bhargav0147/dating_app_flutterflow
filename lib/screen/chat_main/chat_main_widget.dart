...
class ChatMainWidget extends StatefulWidget {
  ...
  static String routePath = '/chatMain';
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Builder(
            builder: (context) {
              final chatFriendList = List.generate(
                  random_data.randomInteger(20, 20),
                  (index) => random_data.randomInteger(20, 20)).toList();

              return ListView.builder(
                padding: EdgeInsets.zero,
                scrollDirection: Axis.vertical,
                itemCount: chatFriendList.length,
                itemBuilder: (context, chatFriendListIndex) {
                  final chatFriendListItem =
                      chatFriendList[chatFriendListIndex];
                  return Padding(
                    padding:

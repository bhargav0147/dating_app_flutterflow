      ...
      child: Column(
        ...
        children: [
          Expanded(
            child: Builder(
              builder: (context) {
                final friendChatList = List.generate(
                    random_data.randomInteger(10, 10),
                    (index) => random_data.randomInteger(10, 10)).toList();
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, friendChatListIndex) {
                    final friendChatListItem =
                        friendChatList[friendChatListIndex];
                    return Padding(
                      padding:
                              ...
                              children: [
                                ...
                                ClipRRect(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    imageUrl:
                                        'https://images.unsplash.com/photo-1581419278555-c1dd991fdfd8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyMXx8YWR1bHR8ZW58MHx8fHwxNzQwMjMyNzA5fDA&ixlib=rb-4.0.3&q=80&w=1080',
                                    width: 300.0,
                                    height: 200.0,
                                    fit: BoxFit.cover,
